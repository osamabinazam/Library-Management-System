...
//           String sql = "insert into users (firstname,lastname,email,phone,address,username,password,age,gender) values (?,?,?,?,?,?,?,?,?)";
    ...
    public boolean updateBook (){
        ...
        try{
            Connection conc=DriverManager.getConnection("jdbc:mysql://localhost:3306/library_ms","root","toor");
            String sql = "update books set book_title = ?, book_author = ? , book_edition = ?, book_copies = ?, book_available = ? , book_publisher = ? , book_price = ?  ";
            PreparedStatement pst = conc.prepareStatement(sql);
    ...
    private void initComponents() {
        ...
        bPrice.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        ...
        bTitle.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        ...
        bAuthor.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        ...
        bEdition.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        ...
        bCopies.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        ...
        bAvailableCopies.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        ...
        bPublisher.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        ...
        jPanel3.add(manage_Books, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 130, 330, -1));
        ...
        jPanel3.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 230, 920, 480));

        jPanel4.setBackground(new java.awt.Color(255, 0, 0));
        jPanel3.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 190, 300, 5));

        getContentPane().add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 0, 1000, 760));
